...
async def create_equity_fundamentals_data_collection_agent(config: RunnableConfig):
    ...
    builder = (
        MuffinAgentBuilder(primary, name="equity_fundamentals")
        .with_system_prompt_template("data_collection/equity_fundamentals.jinja")
