...
from muffin_agent.middlewares.tool_error_handler import (
...
class TestIsPermanentError:
    ...
    def test_case_insensitive(self):
        assert is_permanent_error("MISSING CREDENTIAL 'foo'") is True
        assert is_permanent_error("UNAUTHORIZED") is True
...
class TestCacheKey:
    ...
    def test_same_args_same_key(self):
        ...
        assert get_cache_key(call1) == get_cache_key(call2)
