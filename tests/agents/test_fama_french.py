"""Tests for the Fama-French data collection agent."""

from unittest.mock import AsyncMock, MagicMock, patch

import pytest

from muffin_agent.agents.data_collection.fama_french import MCP_TOOLS
...
class TestMCPTools:
    ...
    def test_mcp_tools_prefix(self):
        for tool_name in MCP_TOOLS:
            assert tool_name.startswith("famafrench_"), f"Unexpected tool: {tool_name}"
