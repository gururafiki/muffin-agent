"""Tests for the fixed income data collection agent."""

from unittest.mock import AsyncMock, MagicMock, patch

import pytest

from muffin_agent.agents.data_collection.fixed_income import MCP_TOOLS
...
class TestMCPTools:
    ...
    def test_mcp_tools_all_start_with_fixedincome(self):
        for tool_name in MCP_TOOLS:
            assert tool_name.startswith("fixedincome_"), f"Unexpected tool: {tool_name}"
