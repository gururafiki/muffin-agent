...
class TestRenderVerdictNode:
    async def test_happy_path_calls_llm_with_evidence(self):
        ...
        with patch(
            "muffin_agent.agents.personas_council.personas.warren_buffett.ModelConfiguration.get_chat_model_for_role",
...
class TestBuildWarrenBuffettAgent:
    async def test_subgraph_exposes_input_contract(self):
        ...
        with patch(
            "muffin_agent.agents.personas_council.personas.warren_buffett.get_tools",
            return_value=[],
        ):
