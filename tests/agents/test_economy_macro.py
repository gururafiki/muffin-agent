"""Tests for the economy macro data collection agent."""

from unittest.mock import AsyncMock, MagicMock, patch

import pytest

from muffin_agent.agents.data_collection.economy_macro import MCP_TOOLS
...
class TestMCPTools:
    ...
    def test_mcp_tools_all_start_with_economy(self):
        for tool_name in MCP_TOOLS:
            assert tool_name.startswith("economy_"), f"Unexpected tool: {tool_name}"
